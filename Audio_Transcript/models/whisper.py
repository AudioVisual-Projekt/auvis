...
def whisper_inference(filename, model_type='base', verbose=False):
    model = whisper.load_model(model_type)
    result = model.transcribe(filename, verbose=verbose)
    return result
...
if __name__ == '__main__':
    ...
    output_text = whisper_inference(filename, model_type=model_type)
    print(output_text)
