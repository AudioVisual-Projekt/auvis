...
from auvis_system.subtask_5_experiments.ASD_Clustering.src.services.evaluation_service import EvaluationService
from auvis_system.subtask_5_experiments.ASD_Clustering.src.models.evaluation_models import ExperimentEvaluationSummary, SessionEvaluationResult
...
def generate_global_overview_csv(experiments_root: str, global_logger: logging.Logger) -> None:
    ...
    for dataset_name, rows in data_by_dataset.items():
        ...
        output_csv_path = os.path.join(os.path.dirname(experiments_root), output_filename)
