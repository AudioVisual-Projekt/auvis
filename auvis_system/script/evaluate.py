# =============================================================================
# evaluate.py – Angepasste Version des AUVIS-Teams
# =============================================================================
#
# Basis: CHiME-MCoRec Baseline evaluate.py
# 
# Vorgenommene Änderungen gegenüber der Baseline:
#
# 1. Multi-Varianten-Auswertung:
#    Die Baseline wertet pro Session genau einen Output-Ordner aus.
#    Diese Version findet automatisch alle Ordner, die mit --output_dir_name
#    beginnen (z.B. "output_bs8_len15", "output_bs12_len20") und wertet
#    sie in einem einzigen Lauf getrennt aus. Das war nötig, um viele
#    Experiment-Varianten effizient vergleichen zu können.
#    Technisch umgesetzt mit glob-Pattern + defaultdict statt einfacher Liste.
#
# 2. --seg_strat Parameter ergänzt:
#    Zusätzlicher CLI-Parameter für Kompatibilität mit anderen Skripten,
#    die diesen Parameter übergeben. Er wird in evaluate.py selbst nicht
#    verwendet, verhindert aber Fehler bei gemeinsamen Aufrufen.
#
# 3. Verbessertes Ausgabe-Format:
#    Strukturiertere Konsolenausgabe mit Session-Trennern und einer
#    abschließenden SUMMARY-Sektion pro Variante.
#
# Rückwärtskompatibilität: vollständig gewährleistet.
# Aufrufe der Baseline mit --output_dir_name output funktionieren unverändert.
# =============================================================================
